...
(function() {
	...
	var pathA = document.getElementById('pathA'),
		...
		menMov = document.getElementById('movilmen'),
	...
	trigger.onclick = function() {
		if (toCloseIcon) {
			...
			menMov.classList.add('openMovil');
			menMov.classList.remove('closeMovil');
			...
			menMov.classList.add('closeMovil');
			menMov.classList.remove('openMovil');
		...
		toCloseIcon = !toCloseIcon;
	      ...
	      $(".hijodeputa").on("click", function(){
         {
			outAC(segmentA);
			outB(segmentB);
			outAC(segmentC);

			// $(".contenedorMovil").removeClass("abrir");
			menMov.classList.remove('openMovil');
