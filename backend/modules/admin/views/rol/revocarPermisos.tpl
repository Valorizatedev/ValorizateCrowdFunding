<p>Seleccione los permisos a revocar para el rol: {$datos.rol_nombre}</p>
<form name="form1" method="POST" enctype="multipart/form-data" action="{$_layoutParams.root}admin/rol/revocarPermiso/{$datos.rol_key}">
    {$i="1"}
    ...
    <table style="width: 100%">
        <tr>
            {foreach $permisos as $dato}
                <td>
                    <input type="checkbox" name="permiso{$i}" value="{$dato.pxr_key}"/>
