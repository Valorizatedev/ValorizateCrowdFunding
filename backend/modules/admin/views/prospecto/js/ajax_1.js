...
$(document).ready(function() {
    ...
    $("#buscarContacto").autocomplete({
        ...
        select: function(event, ui) {
            cantidadcontacto += 1;
            $("#contactos").append("<tr id='contacto" + cantidadcontacto + "'><td><input type = 'hidden' name = 'contacto_key" + cantidadcontacto + "' id = 'contacto_key" + cantidadcontacto + "' value = '" + ui.item.key + "' />" + ui.item.value + "</td><td><input type='text' name='relacion" + cantidadcontacto + "' id='relacion" + cantidadcontacto + "'/></td><td><a href = '#contacto' class = 'btn btn-mini' id = 'quitarcontacto" + cantidadcontacto + "' name = 'quitar' onclick = 'quitarcontacto(" + cantidadcontacto + ")'> <i class = 'icon-remove'> </i></a></td></tr>");
