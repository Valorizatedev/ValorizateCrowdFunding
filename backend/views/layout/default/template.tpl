    ...
    <head>
        ...
        {if isset($_layoutParams.css) && count($_layoutParams.css)}
            {foreach item=css from=$_layoutParams.css}
                <link src="{$css}" rel="stylesheet" type="text/css"></link>
            {/foreach}
        {/if}
        ...
        <script src="{$_layoutParams.root}public/js/formato.js" type="text/javascript"></script>
        
        {if isset($_layoutParams.js_plugin) && count($_layoutParams.js_plugin)}
        {foreach item=js from=$_layoutParams.js_plugin}
        ...
        <body>
            ...
            <div id="footer">
                Copyright &copy; 2013 <a href="http://www.2idigital.co" target="_blank">{$_layoutParams.configs.app_company}</a>
            </div>
        </div>
    </body>
</html>