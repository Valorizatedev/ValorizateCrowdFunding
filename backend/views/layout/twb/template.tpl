...
<html lang="es">
    ...
    <body>
        ...
        <div class="navbar navbar-fixed-bottom">
            <div class="navbar-inner">
                <div class="container">
                    <div style="margin-top: 10px; text-align: center;">Copyright&copy; 2013 <a href="http://www.2idigital.co" target="_blank">www.2idigital.co</a></div>
                </div>
            </div>
        </div>
        ...
        <!--script type="text/javascript" src="{$_layoutParams.root}public/js/formato.js"></script-->
